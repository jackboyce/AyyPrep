...
SWIFT_CLASS("_TtC9Veracross11AppDelegate")
...
SWIFT_CLASS("_TtC9Veracross24StatisticsViewController")
...
@property (nonatomic, weak) IBOutlet UISwitch * _Null_unspecified rememberSwitch;
...
- (void)loadAd;
- (void)backPressedWithSender:(UIBarButtonItem * _Nonnull)sender;
- (void)reloadPressedWithSender:(UIBarButtonItem * _Nonnull)sender;
- (void)didReceiveMemoryWarning;
- (void)prepareForSegue:(UIStoryboardSegue * _Nonnull)segue sender:(id _Nullable)sender;
- (void)parseWithString:(NSString * _Nonnull)string;
- (NSString * _Nonnull)stringToGradeWithGrade:(NSString * _Nonnull)grade;
- (void)loginWithCompletionHandler:(void (^ _Nonnull)(NSString * _Nullable))completionHandler;
- (nonnull instancetype)initWithNibName:(NSString * _Nullable)nibNameOrNil bundle:(NSBundle * _Nullable)nibBundleOrNil OBJC_DESIGNATED_INITIALIZER;
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)aDecoder OBJC_DESIGNATED_INITIALIZER;
@end
